...
<title>SIGEV-Registro Paciente</title>
...
<form method="POST" action="<? echo $_SERVER['PHP_SELF'];?>" name="FormRegistroPaciente" id="FormRegistroPaciente" enctype="multipart/form-data">
    ...
    <table class="contenedor" border="1">
        ...
        <tr>
            ...
            <td><input type="text" name="txtfrepac" id="txtfrepac" placeholder="Fecha de registro de la Ficha" class="cajatexto" readonly="readonly"/></td>
        </tr>
        
        
           <tr>
            <td><input type="text" name="txtcaspac" id="txtcaspac" placeholder="Caso del Paciente " class="cajatexto" value="Presuntivo"/></td>
